...
export const fields = {
  ...
  y_metrics: {
    type: 'SelectMultipleSortableField',
    label: localeMessage.y_axis_metrics,
    choices: [],
    default: [],
    description: localeMessage.y_axis_metrics_desc,
  },
  y_format: {
    type: 'TextField',
    label: localeMessage.y_axis_format,
    default: '',
    description: localeMessage.y_axis_format_desc,
  },
  y_degree: {
    type: 'TextField',
    label: localeMessage.y_axis_degree,
    default: '',
    description: localeMessage.y_axis_degree_desc,
  },
  y_axis_name: {
    type: 'TextField',
    label: localeMessage.y_axis_name,
    default: '',
    description: localeMessage.y_axis_name_desc,
  },
  x_metrics: {
    type: 'SelectMultipleSortableField',
    label: localeMessage.x_axis_metrics,
    choices: [],
    default: [],
    description: localeMessage.x_axis_metrics_desc,
  },
  x_format: {
    type: 'TextField',
    label: localeMessage.x_axis_format,
    default: '',
    description: localeMessage.x_axis_format_desc,
  },
  x_degree: {
    type: 'TextField',
    label: localeMessage.x_axis_degree,
    default: '',
    description: localeMessage.x_axis_degree_desc,
  },
  x_axis_name: {
    type: 'TextField',
    label: localeMessage.x_axis_name,
    default: '',
    description: localeMessage.x_axis_name_desc,
  },
  y_left_metrics: {
    type: 'SelectMultipleSortableField',
    label: localeMessage.y_left_metrics,
    choices: [],
    default: [],
    description: localeMessage.y_left_metrics_desc,
  },
  y_right_metrics: {
    type: 'SelectMultipleSortableField',
    label: localeMessage.y_right_metrics,
    choices: [],
    default: [],
    description: localeMessage.y_right_metrics_desc,
  },
  y_left_format: {
    type: 'TextField',
    label: localeMessage.y_left_format,
    default: '',
    description: localeMessage.y_left_format_desc,
  },
  y_right_format: {
    type: 'TextField',
    label: localeMessage.y_right_format,
    default: '',
    description: localeMessage.y_right_format_desc,
  },
  y_left_degree: {
    type: 'TextField',
    label: localeMessage.y_left_degree,
    default: '',
    description: localeMessage.y_left_degree_desc,
  },
  y_right_degree: {
    type: 'TextField',
    label: localeMessage.y_right_degree,
    default: '',
    description: localeMessage.y_right_degree_desc,
  },

  x_bottom_metrics: {
    type: 'SelectMultipleSortableField',
    label: localeMessage.x_bottom_metrics,
    choices: [],
    default: [],
    description: localeMessage.x_bottom_metrics_desc,
  },
  x_top_metrics: {
    type: 'SelectMultipleSortableField',
    label: localeMessage.x_top_metrics,
    choices: [],
    default: [],
    description: localeMessage.x_top_metrics_desc,
  },
  x_bottom_format: {
    type: 'TextField',
    label: localeMessage.x_bottom_format,
    default: '',
    description: localeMessage.x_bottom_format_desc,
  },
  x_top_format: {
    type: 'TextField',
    label: localeMessage.x_top_format,
    default: '',
    description: localeMessage.x_top_format_desc,
  },
  x_bottom_degree: {
    type: 'TextField',
    label: localeMessage.x_bottom_degree,
    default: '',
    description: localeMessage.x_bottom_degree_desc,
  },
  x_top_degree: {
    type: 'TextField',
    label: localeMessage.x_top_degree,
    default: '',
    description: localeMessage.x_top_degree_desc,
  },

  top_padding: {
    type: 'TextField',
    label: localeMessage.top_padding,
    default: '80',
    description: localeMessage.top_padding_desc,
  },
  bottom_padding: {
    type: 'TextField',
    label: localeMessage.bottom_padding,
    default: '20',
    description: localeMessage.bottom_padding_desc,
  },
  left_padding: {
    type: 'TextField',
    label: localeMessage.left_padding,
    default: '20',
    description: localeMessage.left_padding_desc,
  },
  right_padding: {
    type: 'TextField',
    label: localeMessage.right_padding,
    default: '20',
    description: localeMessage.right_padding,
  },
  is_avg: {
    type: 'CheckboxField',
    label: localeMessage.is_avg,
    default: false,
    description: localeMessage.is_avg,
  },
  is_max_min: {
    type: 'CheckboxField',
    label: localeMessage.is_max_min,
    default: false,
    description: localeMessage.is_max_min_desc,
  },
  is_bar_value: {
    type: 'CheckboxField',
    label: localeMessage.is_bar_value,
    default: false,
    description: localeMessage.is_bar_value_desc,
  },
  line_choice: {
    type: 'SelectMultipleSortableField',
    label: localeMessage.line_choice,
    choices: [],
    default: [],
    description: localeMessage.line_choice_desc,
  },
  bar_choice: {
    type: 'SelectMultipleSortableField',
    label: localeMessage.bar_choice,
    choices: [],
    default: [],
