const zh_CN = {
  ...
  menu_viztype: [
    ...
    { chart: 'echarts_bar', icon: 'fa fa-bar-chart', name: '柱状图' },
    { chart: 'echarts_bar_h', icon: 'fa fa-bar-chart', name: '柱状图（横）' },
    { chart: 'echarts_line', icon: 'fa fa-line-chart', name: '折线图' },
    { chart: 'echarts_line_bar', icon: 'fa fa-line-chart', name: '柱状折线图' },
],
