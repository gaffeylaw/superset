const en_US = {
  ...
  y_axis_format: 'Y axis format',
  y_axis_format_desc: 'Y axis format. The order must match Metirsc. e.g.:ml',
  ...
  x_axis_format: 'X axis format',
  x_axis_format_desc: 'X axis format. The order must match Metirsc. e.g.:ml',
  ...
  y_left_format_desc: 'Left of Y axis format. The order must match Metirsc. e.g.:ml;%;',
  y_right_format: 'Right of Y axis format',
  y_right_format_desc: 'Right of Y axis format. The order must match Metirsc. e.g.:ml;%;',
  ...
  x_bottom_format_desc: 'Bottom of Y axis format. The order must match Metirsc. e.g.:ml;%;',
  x_top_format: 'Top of Y axis format',
  x_top_format_desc: 'Top of Y axis format. The order must match Metirsc. e.g.:ml;%;',
  ...
  x_axis: 'X Aixs',
  y_axis: 'Y Aixs',
  echarts_line: 'Echart Line',
  echart_line: 'Echart Line',
  echart_line_bar: 'Echart Line Bar',
  echarts_line_bar: 'Echart Line Bar',
  echarts_bar_h: 'Echart Horizontal Bar',
  line_bar: 'Line and Bar',
  line_bar_desc: 'Line and Bar',
  bar_choice: 'Bar Metrics',
  line_choice: 'Line Metrics',
  bar_choice_desc: 'Bar Metrics',
  line_choice_desc: 'Line Metrics',
  echart_chart: 'Echart',
  ...
  menu_viztype: [
    ...
    { chart: 'echarts_bar', icon: 'fa fa-bar-chart', name: 'Bar' },
    { chart: 'echarts_bar_h', icon: 'fa fa-bar-chart', name: 'Horizontal Bar' },
    { chart: 'echarts_line', icon: 'fa fa-line-chart', name: 'Line' },
    { chart: 'echarts_line_bar', icon: 'fa fa-line-chart', name: 'Line Bar' },
],
